...
<h1>Nieuw <span class="badge badge-success"></span></h1>
...
<div class="col-10"><div class="row">
  <div class="col-sm-3">
      <div class="card" style="width: 18rem;">
        <img class="card-img-top" src="./images/bloemen1.jpg" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">Bloem 1</h5>
          <p class="card-text">€4,99</p>
          <a href="#" class="btn btn-danger">Bekijken</a>
        </div>11
      </div>
      </div>
  <div class="col-sm-3">
...
<h1>Onder de €2 <span class="badge badge-secondary"></span></h1>
